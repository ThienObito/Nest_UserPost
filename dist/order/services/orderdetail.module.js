...
const oderdetail_service_1 = require("./oderdetail.service");
...
OrderDetailModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([OrderDetails_1.OrderDetail]),
        ],
        controllers: [orderdetail_controller_1.OrderDetailController],
        providers: [oderdetail_service_1.OrderDetailService],
    })
], OrderDetailModule);
